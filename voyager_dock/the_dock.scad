...

{
    ...
    MAGNET_POS = [ FRAME_TR[0], (FRAME_TR[1] - FRAME_BR[1]) / 2 + FRAME_BR[1], -2 ];
    MAGNET_DIAMETER = 10;
    MAGNET_HEIGHT = 4;
    ...
    PALM_TL = FRAME_BL;
    PALM_TR = FRAME_BR;
    PALM_BL = [ PALM_TL[0], PALM_TL[1] - palm_rest_length, -1 ];
    PALM_BR = [ PALM_TR[0], PALM_TR[1] - palm_rest_length, -1 ];
    ...
    module magnet_cutout()
    {
        color("blue") tilt()
        {
            translate([ MAGNET_POS[0], MAGNET_POS[1], -MAGNET_HEIGHT + .1 ])
    ...
    module palm_rest()
    {
        ...
        color("magenta") union()
        {
            hull()
            {
                ...
                {
                    rounded_cylinder(PALM_TL, CORNER_DIAMETER, PADDING);
                    rounded_cylinder([ PALM_TR[0] + (CORNER_DIAMETER) / 2 + PADDING, PALM_TR[1], PALM_TR[2] ],
